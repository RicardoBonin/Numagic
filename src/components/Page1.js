...
const Page1 = ({ pageVisible }) =>
  pageVisible && (
    <div className="page-container">
      <Instruction title="Pick a card" />
      <div className="card-container" id="card-container-1">
        ...
        <Button className="button-select" cardNumber={1} title="Pick" />
      </div>
      <div className="card-container" id="card-container-2">
        ...
        <Button className="button-select" cardNumber={2} title="Pick" />
      </div>
      <div className="card-container" id="card-container-3">
        ...
        <Button className="button-select" cardNumber={3} title="Pick" />
      </div>
      <div className="card-container" id="card-container-4">
        ...
        <Button className="button-select" cardNumber={4} title="Pick" />
      </div>
      <div className="card-container" id="card-container-5">
        ...
        <Button className="button-select" cardNumber={5} title="Pick" />
      </div>
...
const mapStateToProps = ({ page1Visible }) => {
  return {
