...
const Page1 = ({ pageVisible, selectedLanguage }) => {
  const {
    ...
    pageVisible && (
      <div className="page-container">
        ...
        <div className="card-container" id="card-container-2">
          ...
          <Button className="button-select" cardNumber={2} title={button} />
        </div>
        <div className="card-container" id="card-container-3">
          ...
          <Button className="button-select" cardNumber={3} title={button} />
        </div>
        <div className="card-container" id="card-container-4">
          ...
          <Button className="button-select" cardNumber={4} title={button} />
        </div>
        <div className="card-container" id="card-container-5">
          ...
          <Button className="button-select" cardNumber={5} title={button} />
        </div>
...
const mapStateToProps = ({ page1Visible, language }) => {
  return {
